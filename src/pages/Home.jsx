...
const featureData = [
  {
    ...
    imgUrl: featureImg01,
    desc: "Get food at your door-step in 30 minutes.",
  },
          ...
          <Row>
            <Col lg="6" md="6">
              <div className="hero__content  ">
                {/* <h5 className="mb-3">Best Place to order food</h5> */}
                <h1 className="mb-4 hero__title">
                  <span>HUNGRY?</span> Just Order <br /> food from
